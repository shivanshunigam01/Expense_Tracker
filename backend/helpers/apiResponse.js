...
exports.tooManyRequests = function (res, msg) {
    var data = {
        success: false,
    ...
    return res.status(StatusCodes.TOO_MANY_REQUESTS).json(data);
};
...
/**
 * Role changes by Admin at time.
 * @returns {Json}
 */
exports.autoLogoutRequest = function (res, msg) {
    var data = {
        success: false,
        statusCode: 219,
        status: ReasonPhrases.LOCKED,
        message: msg,
    };
    return res.status(219).json(data);
};